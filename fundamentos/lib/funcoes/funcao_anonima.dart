void main() {
  ...
  print("Chamando umafunção anônima ${somarAnonimo(10, 5)}");
  print("Chamando umafunção nomeada ${somarNomeado(10, 5)}");
  ...
  pessoas.forEach((String pessoa) {
    var dados = pessoa.split("|");
    print(
        "${pessoas.indexOf(pessoa) + 1}º Nome: ${dados[0]} Profissão: ${dados[1]}");
  });
