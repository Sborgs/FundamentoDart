void main(List<String> args) {
  ...
  print('''\n // método diference de Set compara dois
  ...
  print('conjuto 1: ${conjuntoNumeros1}');
  print('conjuto 2: ${conjuntoNumeros2}');
